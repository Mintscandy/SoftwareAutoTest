...
import time
import ddt
from MZ2023.EPR_PO.Website.test_case.page_object.AddPage import *
from MZ2023.EPR_PO.Website.test_case.page_object.LogingPage import *
from MZ2023.EPR_PO.Website.test_case.model import myunit, function


@ddt.ddt()
class final(myunit.StartEnd):
    user = ["XTGLY", "123456"]
    data_path = r"C:\Users\Mints_Candy\Desktop\SoftwareAutoTest\MZ2023\EPR_PO\Website\test_data\test_csv.csv"
