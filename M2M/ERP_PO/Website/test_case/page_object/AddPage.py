...
class AddPage(Page):
    fenlei_loc = (By.PARTIAL_LINK_TEXT, "商品分类",)
    add_loc = (By.CSS_SELECTOR,
               "#app > div > div.main-container.hasTagsView > section > div > div.mb8.el-row > div:nth-child(3) > "
               "button",)
    ...
    def type_fenlei(self):
        self.find_element(*self.fenlei_loc).click()
