...
import ddt
import time
from M2M.ERP_PO.Website.test_case.page_object.AddPage import *
from M2M.ERP_PO.Website.test_case.page_object.LogingPage import *
from M2M.ERP_PO.Website.test_case.model import function, myunit


@ddt.ddt()
class final(myunit.StartEnd):
    user = ["XTGLY", "123456"]
    data_path = r"C:\Users\Mints_Candy\Desktop\SoftwareAutoTest\M2M\ERP_PO\Website\test_data\test_csv.csv"
    ...
    def test01(self):
        ...
        name = "test_" + str(time.strftime("%H_%M_%S")) + ".png"
        function.inser_img(self.driver,name)
